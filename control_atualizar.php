<?php
	...
	$sql = "UPDATE tab_produtos SET nome = '$nome', descricao = '$descricao', preco = '$preco' WHERE id = $id";
...
<body>
	...
	<div class="row">
		<div class="col-sm-8 offset-sm-2 centralizado">
			<h1>Produto atualizado com sucesso. Você será redirecionado para a Home em <p id="numero">5</p> segundos.</h1>
		</div>
	</div>
